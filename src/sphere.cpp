...
static bool intersect_sphere(const void * data,
...
new_sphere(const Point3d center,
    ...
    Sphere * sphere = reinterpret_cast<Sphere*>(malloc(sizeof(Sphere)));
    sphere->center = center;
    sphere->radius = radius;
    sphere->color = color;
    sphere->material = material;
    
    Object3d * obj = reinterpret_cast<Object3d*>(malloc(sizeof(Object3d)));
    obj->data = sphere;
...
get_sphere_color(const void * data,
                 const Point3d intersection_point) {
    const Sphere * sphere = reinterpret_cast<const Sphere*>(data);
	return sphere->color;
}
...
get_sphere_normal_vector(const void * data,
                         const Point3d intersection_point) {
    const Sphere * sphere = reinterpret_cast<const Sphere*>(data);
    Vector3d n = Vector3d(sphere->center, intersection_point);
    n.normalize();
    return n;
}
