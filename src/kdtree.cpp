...
build_kd_tree(Object3d ** objects,
    ...
    KDTree * tree = reinterpret_cast<KDTree*>(malloc(sizeof(KDTree)));
...
rec_build(Object3d ** objects,
    ...
    KDNode * node = reinterpret_cast<KDNode*>(malloc(sizeof(KDNode)));
    node->objects = NULL;
...
make_leaf(Object3d ** objects,
    ...
    KDNode * leaf = reinterpret_cast<KDNode*>(malloc(sizeof(KDNode)));
    leaf->plane = NONE;
